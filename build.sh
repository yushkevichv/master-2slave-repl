...
#CHANGE MASTER TO MASTER_HOST='192.168.192.0',MASTER_USER='slave_user',MASTER_PASSWORD='slave_pwd',MASTER_LOG_FILE='mysql-bin.000003',MASTER_LOG_POS=595; START SLAVE;